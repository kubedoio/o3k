...
VALUES
    ('00000000-0000-0000-0000-000000000010', 'm1.tiny', 1, 512, 1, true),
    ('00000000-0000-0000-0000-000000000011', 'm1.small', 1, 2048, 20, true),
    ('00000000-0000-0000-0000-000000000012', 'm1.medium', 2, 4096, 40, true),
    ('00000000-0000-0000-0000-000000000013', 'm1.large', 4, 8192, 80, true),
    ('00000000-0000-0000-0000-000000000014', 'm1.xlarge', 8, 16384, 160, true)
ON CONFLICT (name) DO NOTHING;
